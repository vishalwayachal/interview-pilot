<template>
  <div class="container py-4 settings-bg">
    <div class="alert alert-info mb-4 shadow-sm">
      ...
      >
        <span
          ><i class="el-icon-info mr-2"></i> The following settings are only
          retained locally in your browser.</span
        >
      </div>
    </div>
          ...
          <div class="card-body">
            ...
            <div class="mb-3">
              <label class="form-label fw-bold"
                >GPT Prompt
                <span class="desc_text ms-2"
                  >(Customize the system prompt for GPT answers)</span
                >
              </label>
              <el-input
                type="textarea"
    ...
    <div class="row mt-4">
      <div class="col-12 d-flex justify-content-end">
        <el-button class="btn btn-warning px-4" @click="toDef"
          ><i class="el-icon-refresh mr-1"></i> Reset All Settings</el-button
        >
      </div>
    </div>
  </div>
  ...
  data() {
    return {
      ...
      azure_application_url:
        "https://github.com/interview-copilot/Interview-Copilot/blob/main/docs/azure_speech_service_tutorial.md",
      full_language_codec_url:
        "https://learn.microsoft.com/en-us/azure/ai-services/speech-service/language-support?tabs=stt#speech-to-text",
    };
  },
  mounted() {
